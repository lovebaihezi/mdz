...
const ArgsError = error{ MissingFilePath, UnknownOutputFormat, OptionNoType, UnknownOption } || small_arr.Error;
...
test "test set_option" {
    ...
    try args.set_option("-format=json");
    try std.testing.expect(args.format == Format.JSON);
